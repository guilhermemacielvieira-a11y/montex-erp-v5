  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white">Gerenciador de Relatórios</h1>
            ...
            <CardContent className="p-6 space-y-6">
              <div>
                ...
                <div className="space-y-4 text-sm text-slate-300">
                  <div>
                    <h4 className="font-semibold text-white mb-1">1. Criar Modelos</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-white mb-1">2. Agendar Relatórios</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-white mb-1">3. Visualizar Histórico</h4>
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-blue-500/10 p-4 rounded-lg">
                    <h4 className="font-semibold text-blue-200 mb-2">Automação Completa</h4>
                    <p className="text-sm text-blue-300">Gere relatórios automaticamente em intervalos definidos</p>
                  </div>
                  <div className="bg-emerald-500/10 p-4 rounded-lg">
                    <h4 className="font-semibold text-emerald-200 mb-2">Múltiplos Formatos</h4>
                    <p className="text-sm text-emerald-300">Exporte em PDF, Excel ou CSV conforme necessário</p>
                  </div>
                  <div className="bg-purple-500/10 p-4 rounded-lg">
                    <h4 className="font-semibold text-purple-200 mb-2">Distribuição por Email</h4>
                    <p className="text-sm text-purple-300">Envie automaticamente para múltiplos destinatários</p>
                  </div>
                  <div className="bg-orange-500/10 p-4 rounded-lg">
                    <h4 className="font-semibold text-orange-200 mb-2">Customização Total</h4>
                    <p className="text-sm text-orange-300">Controle filtros, colunas e layout de cada relatório</p>
                  </div>
                </div>
              </div>
            </CardContent>
