    ...
    <div className="flex flex-col h-full bg-gray-950 text-white">
      ...
      <div className="grid grid-cols-5 gap-4 px-6 py-4 border-b border-gray-800">
        {[
          ...
          { label: 'Peso Total', value: (Number(kpis.pesoTotal) || 0).toLocaleString('pt-BR', { maximumFractionDigits: 0 }) + ' kg', icon: Weight, color: 'text-purple-400' },
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm text-gray-400">
                          ...
                          <span className="flex items-center gap-1"><Weight className="w-3 h-3" /> {(() => { const p = parseFloat(envio.pesoTotal || envio.peso_total) || 0; return p.toLocaleString('pt-BR', { maximumFractionDigits: 0 }) + ' kg'; })()}</span>
            ...
            <>
              <div className="flex justify-between items-center mb-4">
                <p className="text-sm text-gray-400">
                  ...
                  {(pecasEnviadas.reduce((s, p) => s + (parseFloat(p.pesoTotal) || parseFloat(p.peso) || 0), 0)).toLocaleString('pt-BR', { maximumFractionDigits: 0 })} kg
                </p>
              </div>
